...
public class ServiceController {
    ...
    ///////////////////////////ItemService/////////////////////////////
    public Boolean addItem(String manufacturer, Integer barcode, String name, String expirationDate, double costPrice,int category, int productID ,String size,String branch){
        try{
 ...
 */
    public void addData() {
        ...
        this.addItem("Tnuva", 0, "Milk 3%", expirationDateStr, 6.9, 0, 0 ,"1L","A");
        this.addItem("Tnuva", 1, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","A");
        this.addItem("Tnuva", 2, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","A");
        this.addItem("Tnuva", 3, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","A");
        this.addItem("Tnuva", 4, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","B");
        this.addItem("Tnuva", 5, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","B");
        this.addItem("Tnuva", 6, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","B");
        this.addItem("Tnuva", 7, "Milk 3%", expirationDateStr, 6.9, 0, 0,"1L","C");
        this.addItem("Tnuva", 8, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","A");
        this.addItem("Tnuva", 9, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","A");
        this.addItem("Tnuva", 10, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","B");
        this.addItem("Tnuva", 11, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","C");
        this.addItem("Tnuva", 12, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","C");
        this.addItem("Tnuva", 13, "Cheese 3%", expirationDateStr, 10, 0, 1,"250g","C");
        this.addItem("Zoglobek", 14, "Salami 5%", expirationDateStr, 15, 1, 2,"500g","A");
        this.addItem("Zoglobek", 15, "Salami 5%", expirationDateStr, 15, 1, 2 ,"500g","A");
        this.addItem("Zoglobek", 16, "Salami 5%", expirationDateStr, 15, 1, 2,"500g","B");
        this.addItem("Zoglobek", 17, "Salami 5%", expirationDateStr, 15, 1, 2, "500g","C");
        this.addItem("Zoglobek", 18, "Salami 5%", expirationDateStr, 15, 1, 2, "500g","G");
        this.addItem("Zoglobek", 19, "Salami 5%", expirationDateStr, 15, 1, 2 ,"500g","F");
        this.addItem("Havat HaBokrim", 20, "Beef Fillet", expirationDateStr, 100, 1, 3,"1k","D");
        this.addItem("Havat HaBokrim", 21, "Beef Fillet", expirationDateStr, 100, 1, 3 ,"1k","H");
        this.addItem("Havat HaBokrim", 22, "Beef Fillet", expirationDateStr, 100, 1, 3, "1k","I");
        this.addItem("Havat HaBokrim", 23, "Beef Fillet", expirationDateStr, 100, 1, 3, "1k","G");
        this.addItem("Havat HaBokrim", 24, "Beef Fillet", expirationDateStr, 100, 1, 3 ,"1k","F");
        this.addItem("Havat HaBokrim", 25, "Beef Fillet", expirationDateStr, 100, 1, 3, "1k","F");
        this.addItem("Havat HaBokrim", 26, "Beef Fillet", expirationDateStr, 100, 1, 3,"1k","F");
        this.addItem("Soltam", 27, "Pot 1L", null, 55, 2, 4 ,"","F");
        this.addItem("Soltam", 28, "Pot 1L", null, 55, 2, 4,"","F");
        this.addItem("Soltam", 29, "Pot 0.5L", null, 55, 2, 4,"","F");
        this.addItem("Soltam", 30, "Pot 0.5L", null, 55, 2, 4,"","F");
        this.addItem("Soltam", 31, "Pot 0.5L", null, 55, 2, 4,"","D");
        this.addItem("Ruhama", 32, "Broom", null, 15, 2, 5,"","D");
        this.addItem("Ruhama", 33, "Broom", null, 15, 2, 5,"","D");
        this.addItem("Ruhama", 34, "Broom", null, 15, 2, 5,"","E");
        this.addItem("Ruhama", 35, "Broom", null, 15, 2, 5,"","E");
        this.addItem("Ruhama", 36, "Broom", null, 15, 2, 5,"","E");
        this.addItem("Ruhama", 37, "Broom", null, 15, 2, 5,"","E");
        this.addItem("Ruhama", 38, "Broom", null, 15, 2, 5,"","I");
        this.addItem("Ruhama", 39, "Broom", null, 15, 2, 5,"","H");
    }
